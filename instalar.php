...
/**
 * Script de Instalación Inicial para Canal360
...
echo "\n\033[34m====================================================\033[0m\n";
echo "\033[34m    INSTALACIÓN INICIAL - CANAL360                 \033[0m\n";
echo "\033[34m====================================================\033[0m\n";
...
// 8. Storage Link
echo "\n\033[33mCreando enlace simbólico para storage...\033[0m\n";
ejecutar('php artisan storage:link');

echo "\n\033[34m====================================================\033[0m\n";
echo "\033[32m       ¡INSTALACIÓN COMPLETADA CON ÉXITO!          \033[0m\n";
echo "\033[34m====================================================\033[0m\n\n";
echo "Para iniciar el servidor local ejecuta: php artisan serve\n\n";
