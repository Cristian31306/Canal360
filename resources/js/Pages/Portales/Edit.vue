...
const form = useForm({
    nombre: props.portal.nombre,
    usuario: props.portal.usuario,
    password: props.portal.password,
    aseguradora_id: props.portal.aseguradora_id || '',
    link: props.portal.link || '',
    notas: props.portal.notas || '',
});
