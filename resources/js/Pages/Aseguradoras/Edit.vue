    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4 w-full">
                <Link :href="route('aseguradoras.index')" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 transition-colors flex-shrink-0">
                ...
                <div class="px-4 py-6 sm:p-8">
                    <form @submit.prevent="submit" class="space-y-8">
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                                ...
                                <div class="col-span-1 md:col-span-2">
                                    ...
                                    <div class="mt-2 flex items-center gap-x-3">
                                        <div v-if="previewLogo" class="h-16 w-16 overflow-hidden rounded-md bg-white border border-gray-200 dark:border-gray-700 flex items-center justify-center p-1 relative group">
                                            <img :src="previewLogo" alt="Preview" class="h-full w-full object-contain" />
                                            <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                                <button type="button" @click="onRemoveLogo" class="text-white bg-red-600 hover:bg-red-700 rounded-full p-1" title="Eliminar Imagen">
                        ...
                        <div class="flex items-center justify-between border-t border-gray-200 dark:border-gray-700 pt-6">
                            ...
                            <Link :href="route('aseguradoras.destroy', aseguradora.id)" method="delete" as="button" class="text-sm font-semibold leading-6 text-red-600 hover:text-red-500 transition-colors">
